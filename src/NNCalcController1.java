...
public final class NNCalcController1 implements NNCalcController {
    ...
    private static void updateViewToMatchModel(NNCalcModel model,
        ...
        //get the input natural number from input
        NaturalNumber input = model.top();
        NaturalNumber output = model.bottom();
        //displays the input and output to the view
        view.updateTopDisplay(input);
        view.updateBottomDisplay(output);

        //check the condition for subtract. requires top >= bottom
        ...
        //check the condition for division, requires bottom > 0
        ...
        //check the condition for power, requires bottom <= INT_LIMIT
        ...
        //check the condition for root, requires 2 <= bottom <= INT_LIMIT
