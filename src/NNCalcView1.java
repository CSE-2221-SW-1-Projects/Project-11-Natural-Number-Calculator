...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        //add the operator buttons to the calculator view
        ...
        //add the clear, swap, and enter buttons
         ...
         */
        JScrollPane inputTextScrollPanes = new JScrollPane(this.tTop);
        JScrollPane outputTextScrollPanes = new JScrollPane(this.tBottom);

        /*
         * Create main button panel
         */
        JPanel mainButtonsPanel = new JPanel(new GridLayout(
        ...
        //first row
        mainButtonsPanel.add(this.bDigits[7]);
        mainButtonsPanel.add(this.bDigits[8]);
        mainButtonsPanel.add(this.bDigits[9]);
        mainButtonsPanel.add(this.bAdd);
        //second row
        mainButtonsPanel.add(this.bDigits[4]);
        mainButtonsPanel.add(this.bDigits[5]);
        mainButtonsPanel.add(this.bDigits[6]);
        mainButtonsPanel.add(this.bSubtract);
        //third row
        mainButtonsPanel.add(this.bDigits[1]);
        mainButtonsPanel.add(this.bDigits[2]);
        mainButtonsPanel.add(this.bDigits[3]);
        mainButtonsPanel.add(this.bMultiply);
        //forth row
        mainButtonsPanel.add(this.bDigits[0]);
         ...
         */
        JPanel sideButtonsPanel = new JPanel(new GridLayout(
         ...
         */
        combinedButtonPanel.add(mainButtonsPanel);
        combinedButtonPanel.add(sideButtonsPanel);
         ...
         * and top to bottom
         */
        this.add(inputTextScrollPanes);
        this.add(outputTextScrollPanes);
        ...
        //register the digit buttons as observer
        for (int i = 0; i < 10; i++) {
            this.bDigits[i].addActionListener(this);
        }
        //register the operator buttons as observer
